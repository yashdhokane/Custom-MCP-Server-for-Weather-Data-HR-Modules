 ...
 */
declare function fetchWeatherApi(url: string, params: any, retries?: number, backoffFactor?: number, backoffMax?: number, fetchOptions?: RequestInit): Promise<WeatherApiResponse[]>;
